            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                        <div class="col-md-6 form-group p_star">
                            <input type="text" class="form-control" id="first" value="${sessionScope.client.nom }" name="name">
                            <span class="placeholder" data-placeholder="First name"></span>
                        </div>
                        <div class="col-md-6 form-group p_star">
                            <input type="text" value="${sessionScope.client.prenom}" class="form-control" id="last" name="name">
                            <span class="placeholder" data-placeholder="Last name"></span>
                        </div>
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" id="company" name="company" value="${sessionScope.client.email}">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="order_box">
                        ...
                        <ul class="list">
                            <li><a href="#"><h4>Produits <span>Total</span></h4></a></li>
                            <c:forEach var="entry" items="${produits}">
                            <li><a href="#">${entry.key.nom}<span class="middle">x ${entry.value}</span> <span class="last">${entry.value*entry.key.prix}</span></a></li>
                           	</c:forEach>
                        </ul>
                        <ul class="list list_2">
                           
                            <li>Total <span>${total} Dhs</span></li>
                        </ul>
                        
                        
                        <div class="text-center">
                         <form method="post" action="/Ecommerce/valider-commande">
                          		<button type="submit" class="button button-paypal" >Payer</button>
                          </form>
