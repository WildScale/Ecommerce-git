      ...
      <div class="row">
        <div class="col-md-4 col-lg-3 mb-4 mb-md-0">
          ...
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3><a href="tel:454545654">00 00 0 000 0</a></h3>
          ...
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3><a href="">aromashop3@gmail.com</a></h3>
              <p>Envoyez nous un message!</p>
            </div>
          </div>
        </div>
        <div class="col-md-8 col-lg-9">
          <form action="/Ecommerce/mail" class="form-contact contact_form"  method="post" >
            <div class="row">
              <div class="col-lg-5">
                ...
                <div class="form-group">
                  <input class="form-control" name="email" id="email" type="email" placeholder="Adresse E-mail">
                </div>
                <div class="form-group">
                  <input class="form-control" name="objet" id="objet" type="text" placeholder="Objet">
                </div>
              </div>
              <div class="col-lg-7">
                <div class="form-group">
                    <textarea class="form-control different-control w-100" name="message" id="message" cols="30" rows="5" placeholder="Votre message"></textarea>
                </div>
              </div>
            </div>
            <div class="form-group text-center text-md-right mt-3">
              <button type="submit"  class="button button--active button-contactForm" >Envoyer</button>
            </div>
          </form>
        </div>
      </div>
