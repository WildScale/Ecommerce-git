			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						<div class="hover">
							...
							<p>Connectez-vous !</p>
							<a class="button button-account" href="login.html">Se
								Connecter</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner register_form_inner">
						...
						<form style="margin-top:20px" class="row login_form" action="/Ecommerce/inscription" method="post" id="register_form">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="nom"
									placeholder="Nom de famille" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Username'">
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="email" name="prenom"
									placeholder="Prénom" onfocus="this.placeholder = ''"
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="confirmPassword"
									name="rue" placeholder="Rue/Boulevard"
									onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Confirm Password'">
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit"
									class="button button-register w-100">S'inscrire</button>
							</div>
						</form>
					</div>
				</div>
