			...
			<div class="billing_details">
				<div class="row">
					<div class="col-lg-8">
						...
						<form class="row contact_form" action="/Ecommerce/ajouterProduit"
							enctype="multipart/form-data" method="post"
							novalidate="novalidate">
							<div class="col-md-6 form-group p_star">
								<input type="text" class="form-control"
									placeholder="Nom du produit" id="first" name="nom_produit">
								<span class="placeholder" data-placeholder="First name" required></span>
							</div>
							<div class="col-md-6 form-group p_star">
								<input type="number" class="form-control"
									placeholder="Prix du produit" id="last" name="prix_produit">
							...
							<div class="col-md-12 form-group p_star">
								<input type="file" class="form-control" id="last" name="image">
								<span class="placeholder" data-placeholder="Image" required></span>
							</div>
							<button style="margin-left: 20px" type="submit" value="Ajouter"
								class="button button-login">Ajouter</button>
